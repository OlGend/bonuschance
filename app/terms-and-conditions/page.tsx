  ...
  return (
    <main className="sm:px-16 px-6 bg-primary relative overflow-hidden z-1 double-page">
      ...
      <div className="container">
        <h1 className="mb-3">Welcome to bonus-chance.com</h1>
        <p className="mb-3">
        ...
        <p className="mb-3">
          ...
          (&apos;Program&apos;) offered by bonus-chance.com (&apos;we,&apos;
        ...
        <p className="mb-3">
          ...
          they have deposited on the brands associated with bonus-chance.com Our
        ...
        <p className="mb-3">
          ...
          email at support@bonus-chance.com.
        </p>
        <p className="mb-3">
